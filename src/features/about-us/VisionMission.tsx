export default function VisionMission() {
  return (
    <div className="w-full relative bg-visi-misi">
      <div className="absolute inset-0 bg-overlay"></div>
      <div className="container mx-auto px-3 md:px-44 py-16 relative">
        <div className="text-[40px] font-medium font-pathway-extreme text-white mb-10">
          Visi & Misi
        </div>
        <div className="flex gap-16">
          <div className="flex-1 text-xl font-medium font-pathway-extreme">
            <div className="text-green mb-4">Visi</div>
            <div className="text-primary-dark text-[32px] leading-normal">
