  ...
  return (
    <div className="container mx-auto px-4 md:px-44 py-10 md:py-20">
      ...
      <div className="flex gap-8 overflow-x-auto md:overflow-none md:flex-nowrap flex-nowrap md:mt-10 md:px-0 scrollbar-hide">
        <div className="group shrink-0 w-[65%] md:min-w-0 md:flex-1 bg-white border-b-2 border-primary-light hover:border-action-hover transition-all duration-300 cursor-pointer">
          <Image
          ...
          <div className="px-2 pt-3 pb-8">
            ...
            <div className="text-primary-light group-hover:text-action-hover text-base md:text-xl font-medium mb-3 font-pathway-extreme transition-colors duration-300">
