    ...
    <div className="mx-auto max-w-6xl px-4 md:px-10 relative py-10 md:py-16 ">
      ...
      <div className="space-y-6">
        {programs.map((data, index) => (
          ...
          >
            <div
              className="md:flex justify-between items-center p-6 md:p-10 rounded-tl-[64px] rounded-bl-lg rounded-br-[64px] rounded-tr-lg relative overflow-hidden bg-center bg-cover gap-10"
              style={{
                backgroundImage: `url("${getFullImageUrl(data.image)}")`,
              }}
            >
              <div className="absolute bg-black opacity-50 inset-0"></div>
              <div className="md:w-7/12 text-white relative md:py-6">
                <div className="font-pathway-extreme text-[24px] md:text-[32px] font-light mb-5 md:mb-8">
                  {data.name}
                </div>
              ...
              <div className="md:w-5/12 relative mt-5 md:mt-16 md:mt-0">
